...
* Created a Jupyter Notebook file called `mission_to_mars.ipynb` and used this file to complete all of the scraping and analysis tasks. The following outlines what was to scraped.

### NASA Mars News

* Scraped the [NASA Mars News Site](https://mars.nasa.gov/news/) and collected the latest News Title and Paragraph Text. Assigned the text to variables for later access.
...
* Next, created a route called `/scrape` that imports `scrape_mars.py` script and calsl the `scrape` function.
